...
import { poiData, trafficFlow, exclusionZones, chargingStations } from "../drizzle/schema";
dotenv.config();
...
const roads = [
  ...
  { roadName: "南江滨大道", roadLevel: "arterial", startLat: 26.0234, startLng: 119.2834, endLat: 26.0234, endLng: 119.3456, centerLat: 26.0234, centerLng: 119.3145, dailyFlow: 38000, peakFlow: 2000, evRatio: 0.09, heatWeight: 0.80, district: "仓山区" },
...
const zones = [
  ...
  { name: "三坊七巷历史文化保护区", zoneType: "heritage", centerLat: 26.0823, centerLng: 119.3012, radiusKm: 0.5, description: "国家级历史文化街区" },
  { name: "西湖公园绿地保护区", zoneType: "park", centerLat: 26.0912, centerLng: 119.2934, radiusKm: 0.4, description: "城市公园绿地" },
...
const stations = [
  ...
  { name: "国家电网福州火车站充电站", latitude: 26.0834, longitude: 119.3323, district: "晋安区", connectors: 16, power: 120.0, operator: "国家电网" },
